...
export default function ResidentialPropertyGridClient({
    properties,
}: {
                        ...
                        >
                            ...
                            <div className="p-4">
                                <p className="text-[11px] font-semibold uppercase tracking-wide text-[var(--color-accent)]">
                                    {String(p.transactionType || "").toUpperCase() === "RENT" ? "FOR RENT" : "FOR SELL"} · RESIDENTIAL
                                </p>
                                ...
                                {p.codeNo ? (
                                    <p className="mt-1 text-[11px] font-bold text-[var(--color-header)]">
                                        <span className="text-[var(--color-accent)]">Code No : {p.codeNo}</span>
                                    </p>
                                ) : null}
